    ...
    return (
        <>
            <Row className='justify-content-center align-items-center text-center'>
                <h1 className="hed1" style={{ color: "#151414" }}>What We Can Do For You</h1>
            </Row>
            <Row className='justify-content-center align-items-center  py-5'>
                <Col md={10}>
                    <Row className='justify-content-center '>
                        <Col md={3}>
                            <div className='d-flex flex-column justify-content-center align-items-center thirdsecdiv animate__pulse'>
