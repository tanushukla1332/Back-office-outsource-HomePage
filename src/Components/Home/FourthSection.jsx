                    ...
                    <div >
                        <div className='d-flex justify-content-center align-items-center gap-2'>
                            <div  className='col-md-3'> 
                                <h4 className='hed4 text-center ps-5'  style={{ color: "#4DA8B4",marginTop:"-60px" }}>Book Free Consultation</h4>
                                <p className='para text-center' style={{ color: "#4DA8B4" }}>Help us understand your needs,
                                    We are in all ears.</p>
                            </div>
                            <div  className='col-md-3'>
