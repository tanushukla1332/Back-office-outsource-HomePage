    ...
    <Row className="d-flex justify-content-center align-items-center py-5">
          <div className="text-boxes d-flex flex-column gap-3 col-md-5">
            <div className="text-box" > 
              <h3 className='hed4'>Focused on Business Growth</h3>
              <p className='para'>
            ...
            <div className="text-box" style={{backgroundColor:"#061B49"}}>
              <h3 className='text-white hed4'>Customized Solutions</h3>
            ...
            <div className="text-box">
              <h3 className='hed4'>Quality Assurance</h3>
              <p  className='para'>
